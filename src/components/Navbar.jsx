    ...
    <header className="bg-white border-b border-slate-200 sticky top-0 z-30 shadow-xs">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          {/* Center / Role Badge Notice */}
          <div className="hidden md:flex items-center gap-2">
            {isCounselor ? (
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-purple-50 border border-purple-200 text-purple-800 text-xs font-semibold shadow-xs">
                <ShieldCheck className="w-4 h-4 text-purple-600" />
                <span>Counselor Admin Portal</span>
                <span className="bg-purple-200 text-purple-900 text-[10px] px-1.5 py-0.5 rounded-md font-bold uppercase tracking-wider">
                  Full Access
                </span>
              </div>
            ) : (
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-50 border border-emerald-200 text-emerald-800 text-xs font-semibold shadow-xs">
                ...
                <span className="bg-emerald-200 text-emerald-900 text-[10px] px-1.5 py-0.5 rounded-md font-bold uppercase tracking-wider">
                  Add Students Only
                </span>
              </div>
            )}
          ...
          {/* Right actions: Demo Switcher + User Info + Logout */}
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              <button
                ...
                title="Quickly test Counselor vs Trainer view"
              >
              ...
              {showDemoMenu && (
                <>
                  ...
                  />
                  <div className="absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-2xl border border-slate-200 py-2 z-50 animate-slide-in">
                    <div className="px-3 py-1.5 text-[11px] font-bold text-slate-400 uppercase tracking-wider">
                      Quick Demo Switcher
                    </div>
                    <button
                      onClick={() => {
                        switchDemoUser('counselor');
